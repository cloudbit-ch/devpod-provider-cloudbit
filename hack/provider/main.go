...
var checksumMap = map[string]string{
	"./release/devpod-provider-cloudbit-linux-amd64":       "##CHECKSUM_LINUX_AMD64##",
	"./release/devpod-provider-cloudbit-linux-arm64":       "##CHECKSUM_LINUX_ARM64##",
	"./release/devpod-provider-cloudbit-darwin-amd64":      "##CHECKSUM_DARWIN_AMD64##",
	"./release/devpod-provider-cloudbit-darwin-arm64":      "##CHECKSUM_DARWIN_ARM64##",
	"./release/devpod-provider-cloudbit-windows-amd64.exe": "##CHECKSUM_WINDOWS_AMD64##",
}
